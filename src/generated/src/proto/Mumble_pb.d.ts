...
export class ChannelState extends jspb.Message {
  ...
  hasIsEnterRestricted(): boolean;
  clearIsEnterRestricted(): void;
  getIsEnterRestricted(): boolean | undefined;
  setIsEnterRestricted(value: boolean): void;

  hasCanEnter(): boolean;
  clearCanEnter(): void;
  getCanEnter(): boolean | undefined;
...
export class UserState extends jspb.Message {
  ...
  clearTemporaryAccessTokensList(): void;
  getTemporaryAccessTokensList(): Array<string>;
  setTemporaryAccessTokensList(value: Array<string>): void;
  addTemporaryAccessTokens(value: string, index?: number): string;

  clearListeningChannelAddList(): void;
  getListeningChannelAddList(): Array<number>;
  setListeningChannelAddList(value: Array<number>): void;
  addListeningChannelAdd(value: number, index?: number): number;

  clearListeningChannelRemoveList(): void;
  getListeningChannelRemoveList(): Array<number>;
  setListeningChannelRemoveList(value: Array<number>): void;
  addListeningChannelRemove(value: number, index?: number): number;
...
export namespace UserState {
  export type AsObject = {
    ...
    recording?: boolean,
    temporaryAccessTokensList?: Array<string>,
    listeningChannelAddList?: Array<number>,
    listeningChannelRemoveList?: Array<number>,
  }
}
